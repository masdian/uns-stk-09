...
# Penduga Selang untuk Proporsi 1 Populasi
...
.pull.center[
### Dugaan Selang Kepercayaan $\left(1 − \alpha\right)$ bagi $p$
...
.pull.center[
### Dugaan Selang Kepercayaan $\left(1 − \alpha\right)100\%$ bagi $p_1-p_2$
]

<br><br><br>

$$(\hat{p}_1-\hat{p}_2)-z_\frac{\alpha}{2}\sqrt{\dfrac{\hat{p}_1(1-\hat{p}_1)}{n_1}+\dfrac{\hat{p}_2(1-\hat{p}_2)}{n_2}}<p<(\hat{p}_1-\hat{p}_2)+z_\frac{\alpha}{2}\sqrt{\dfrac{\hat{p}_1(1-\hat{p}_1)}{n_1}+\dfrac{\hat{p}_2(1-\hat{p}_2)}{n_2}}$$
